...
<body>
    ...
    <main>
                        ...
                        <div
                            ...
                            <div class="d-lg-flex align-items-center">
                                ...
                                <img src="{{ asset('website_images/'.$user->image_1) }}" alt=""
                                    style='border-radius:15px' class="img-fluid" height='150px' width='150px'>
                                @else
                                ...
                                <div class="ms-lg-4">
                                    <h1 class="fs-2 mb-1">{{ $user->heading_1 ?? "Top-Up, Pay Bills, Stay Connected." }}
                                    </h1>
                                    <span>{{ $user->sub_heading_1 ?? "Top Up Airtime, Data, Cable Subscriptions, and
                                        More, All at
                            ...
                            <div class="mt-3 mt-lg-0">
                                <!-- btn -->
                                <a href="/login" class="btn btn-dark">Get Started</a>
                            </div>
                        </div>
                    </div>
        ...
        <section class="my-lg-14 my-8 bg-light-warning"
            style='border:5px solid #856404;border-left:0px;border-right:0px'>
            <div class="container ">
                ...
                <div class="row gy-50 gx-50">
                    <div class="col-12 col-md-6 col-lg-4" data-show="startbox">
                        ...
                        <div class="process-step ">
                            ...
                            <div class="process-body pt-10 ms-30"><a class="process-title h4 text-black"
                                    href="#">Everything
                                    Automated</a>
                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="100">
                        ...
                        <div class="process-step ">
                            ...
                            <div class="process-body pt-10 ms-30"><a class="process-title h4 text-black"
                                    href="#">Redo Transaction</a>
                                <p class="process-text text-black">Experience hassle-free transaction retries with our
                                    one-click
                                    Redo Transaction feature.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="200">
                        ...
                        <div class="process-step ">
                            ...
                            <div class="process-body pt-10 ms-30"><a class="process-title h4 text-black" href="#">Bulk
                                    Purchase</a>
                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="200">
                        ...
                        <div class="process-step ">
                            ...
                            <div class="process-body pt-10 ms-30"><a class="process-title h4 text-black"
                                    href="#">Schedule For Later
                                    Purchase</a>
                                <p class="process-text text-black">Plan your purchases ahead with our 'Schedule for
                                    Later Purchase'
                                    feature.
                                </p>
                            </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="200">
                        ...
                        <div class="process-step ">
                            ...
                            <div class="process-body pt-10 ms-30"><a class="process-title h4 text-black" href="#">Add Up
                                    Beneficiaries</a>
                                <p class="process-text text-black">Simplify future purchases by saving contacts, decoder
                                    numbers, and
                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="200">
                        ...
                        <div class="process-step ">
                            ...
                            <div class="process-body pt-10 ms-30"><a class="process-title h4 text-black" href="#">24/7
                                    Support
                                    System</a>
                                <p class="process-text text-black">Count on our 24/7 support system for assistance
                                    anytime you need it.
                                </p>
                            </div>
                        </div>
