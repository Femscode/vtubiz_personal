                    ...
                    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                        ...
                        <h1 class="text-white lh-base fw-bold fs-2x fs-lg-3x mb-15">
                            ...
                            <span
                                ...
                                <span id="kt_landing_hero_text">the most convenient way ever!</span>
                            </span>
                        </h1>
                        <!--end::Title-->

                        <!--begin::Action-->
                        <a href="/register" class="btn btn-primary">Paycirclex Your Payroll</a>
                        <!--end::Action-->
                    </div>
                    <!--end::Heading-->
        ...
        <div class="mb-n10 mb-lg-n20 z-index-2">
            ...
            <div class="container">
                ...
                <div class="text-center mb-17">
                    <!--begin::Title-->
                    <h3 class="fs-2hx text-white mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">
                        How it Works</h3>
                    <!--end::Title-->

                    <!--begin::Text-->
                    <div class="fs-5 text-muted fw-bold">
                        Save yourself the stress of single transfers<br />
                        Embrace the fastest and the easiest way!
                    </div>
                    <!--end::Text-->
                </div>
                <!--end::Heading-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <div class="fw-semibold fs-6 fs-lg-4 text-muted">
                              ...
                              Manually add account details of payee, import from an excel or csv sheet
                              or generate a live link that allows your payee to fill individuals account details
                            </div>
                            <!--end::Description-->
                        </div>
                        <!--end::Story-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <div class="fw-semibold fs-6 fs-lg-4 text-muted">
                               ...
                               Check the total amount required to complete the bulk transfer and initiate the transfer, with a single click.
                            </div>
                            <!--end::Description-->
                        </div>
                        <!--end::Story-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <div class="fw-semibold fs-6 fs-lg-4 text-muted">
                               ...
                               Get live status of the transfer as we process it within few seconds.
                            </div>
                            <!--end::Description-->
                        </div>
                        <!--end::Story-->
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo34/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Feb 2023 08:08:11 GMT -->
