    ...
    <script>
        $(document).ready(function() {
				   ...
				   $("#create_hostel_form").submit(async function(e) {
                       e.preventDefault()
                       swal('Creating property, please wait...')
                            ...
                            $.ajax({
                                ...
                                success: (data) => {
                                    swal.close()
                                    swal("Success", 'Hostel/Property created successfully', 'success');
                                    console.log(data)
                                ...
                                error: function(data) {
                                    console.log(data);
                                    swal.close()
                                    swal('Oops', 'Hostel/Property not created','error')
                                }
                            });
						});
     ...
     $('body').on('click', '#delete_hostel', function () {
        ...
        async function resetAccount(el,id) {
                ...
                if (willUpdate) {
                    ...
                    swal("Hostel/Property will not be deleted  :)");
                }
            }
